	...
	<div class="row">
		...
		<div class="update col-md-10 col-md-offset-1 text-center">
			<form action="{{url('update-admin')}}" method="post">
				<br>
				<input type="text" name="name" value="{{$admin->name}}" placeholder="Ad" class="form-control">
				<br>
				<input type="email" name="email" value="{{$admin->email}}" placeholder="E-poçt ünvanı" class="form-control">
				<br>
