...
<div class="container-fluid">
	<div class="row">
		...
		<div class="container">
			...
			<a href="{{url('sent-muellim')}}" class="sagirdButton btn">Göndərilən</a>
				...
				<tbody>
					@foreach($mails as $mail)
						<tr>
							...
							<td>
								<a href="{{url('show-mail-qebul-muellim',$mail->id)}}" class="btn btn-xs btn-default">
									<i class="fa fa-eye"></i>
								</a>
			...
			<div class="mesajYaz col-md-5 ">
				<div class="row">
					...
					<div class="content">
						<form action="{{url('send-muellim')}}" method="post">
