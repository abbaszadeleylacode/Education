	...
	<div class="row">
		<div class="panel col-md-4 col-sm-10 col-xs-10 col-md-offset-4 col-sm-offset-1 col-xs-offset-1" style="margin-top:40px">
			...
			<div class="panel-body">
				...
				<form action="{{url('save-meeting')}}" enctype="multipart/form-data" method="post">
					...
					<br>
					<textarea name="about" id="" cols="30" rows="10" placeholder="Məzmun..." class="form-control"></textarea>
					<br>
